...
INICIO:
	...
	MOVLW b'11111001' 		;Frecuencia del reloj y configuración de canal
	MOVWF ADCON0
...
CONVERTIDOR:
	...
	MOVWF PORTD 			;Se pone un 7 en el puertob
	GOTO CONVERTIDOR 		;Se vuelve a INICIO
	
OP1: 
	MOVLW H'01' 			;Se pone un 1 en el puerto D
	MOVWF PORTD
	GOTO CONVERTIDOR
	
OP2:
	MOVLW H'03' 			;Se pone un 3 en el puerto D
	MOVWF PORTD 
	GOTO CONVERTIDOR 
