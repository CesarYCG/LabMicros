...
include <p16f877.inc> 			;Se cargan las librerias y el mapa de memoria
	...
	org 0h 
	goto INICIO 			;Su ubicación es en el espacio de memoria 
	org 5h 				;Se ubica en el espacio de memoria 
...
INICIO:
	...
	MOVLW b'11111001' 		;Frecuencia del reloj y configuración de canal 1
	MOVWF ADCON0
...
CONVERTIDOR:
	...
	MOVLW b'11111001' 		;Frecuencia de reloj, convertidor a/d
	MOVWF ADCON0
	BSF ADCON0,2
	CALL RETARDO
...
CANAL: 
	MOVF CANAL5, w 			;Se mueve canal5 en w
	SUBWF CANAL6,w 			;Se resta CANAL6-CANAL5 y se guarda en W
...
CANALCINCO:
	MOVF CANAL5, w 			;Se mueve canal6 en w
	SUBWF CANAL7,w 			;Se resta CANAL6-CANAL7 y se guarda en W
	BTFSS STATUS, 1 		;Carry se apaga si el resultado es negativo 
